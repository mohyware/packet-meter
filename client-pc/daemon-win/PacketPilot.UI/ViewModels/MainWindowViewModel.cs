using PacketPilot.UI.Commands;
using PacketPilot.UI.Services;
using System;
...
namespace PacketPilot.UI.ViewModels
{
    ...
    public sealed class MainWindowViewModel : INotifyPropertyChanged
    {
        ...
        private string _serviceName = "PacketPilotDaemon";
        ...
        private const string DEFAULT_CLOUD_HOST = "api.packetpilot.com";
        ...
        private async void LoadInitialConfigAsync()
        {
            try
            {
                ...
                if (ServerHost == DEFAULT_CLOUD_HOST || ServerHost.Contains("packetpilot.com"))
                {
