...
namespace Daemon.Daemon
{
    public class Daemon : IHostedService, IDisposable
    {
        ...
        public Daemon(PacketMeter.Config.Config config, Logger.Logger logger, ConfigPathProvider configPathProvider)
        {
            _config = config;
            _logger = logger;
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            _logger.Info("Starting PacketMeter daemon components");
            StartConfigWatcher();
        ...
        private void InitializeComponents()
        {
            ...
            _reporter = new Reporter.Reporter(reporterConfig, _logger, _processMonitor, _trafficMonitor, reporterMode);
        }
        ...
        private async Task StopComponentsAsync()
        {
            ...
            _logger.Info("Stopping PacketMeter daemon components");
