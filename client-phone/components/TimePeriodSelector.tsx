        ...
        {periods.map((period) => (
          <TouchableOpacity
            ...
            style={[
              ...
              {
                backgroundColor:
                  selectedPeriod === period ? selectedBg : chipBg,
              },
            ]}
      ...
      {selectedPeriod !== 'month' && (
        <View style={styles.countContainer}>
          <ThemedText style={styles.countTitle}>
            Last {selectedPeriod === 'day' ? 'days' : 'weeks'}:
          </ThemedText>
          <View style={styles.countButtons}>
            {Array.from(
              { length: maxCounts[selectedPeriod as keyof typeof maxCounts] },
              (_, i) => i + 1
            ).map((count) => (
              <TouchableOpacity
                activeOpacity={0.8}
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      selectedCount === count ? selectedBg : chipBg,
                  },
                ]}
