...
import { Platform, SafeAreaView, StatusBar, StyleSheet, Modal, TouchableOpacity, View } from "react-native";
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.header}>
                    ...
                    <TouchableOpacity onPress={onClose} style={styles.closeButton}>
                        <ThemedText style={styles.closeButtonText} darkColor="#fff" lightColor="#fff">
                            ✕
                        </ThemedText>
                    </TouchableOpacity>
                </View>
