...
export default function HomeScreen() {
  ...
  return (
    <ThemedView style={styles.container}>
      <FlatList
        ref={listRef}
        data={listData as AppUsageDataAPI[]}
        ...
        keyExtractor={(item: AppUsageDataAPI, index: number) =>
          item.packageName ?? index.toString()
        }
