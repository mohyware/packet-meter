...
export default function DeviceDetailPage() {
    ...
    const { reports, isLoading: isLoadingUsage } = useDeviceUsage(deviceId || '', 100)
    const { devices, isLoading: isLoadingDevices, updateDeviceAsync, isUpdating, deleteDeviceAsync, isDeleting } = useDevices()
    ...
    return (
        <div className="w-full">
            <div className="flex justify-between items-start mb-8">
                <div className="flex-1">
                    {editingName ? (
                        ...
                        <h2 className="text-3xl font-semibold text-gray-800 mb-2">{device.name}</h2>
                    )}
            ...
            <h3 className="text-2xl font-semibold text-gray-800 mb-6">Usage Reports</h3>
            {reports.length === 0 ? (
                <div className="text-center py-12 text-gray-600">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={() => setShowDeleteConfirm(false)}>
                    <div className="bg-white rounded-lg shadow-lg max-w-md w-full p-6" onClick={(e) => e.stopPropagation()}>
                        ...
                        <p className="text-sm text-gray-600 mb-4">
                            Are you sure you want to delete <strong>{device.name}</strong>? This action cannot be undone and will delete all associated usage reports.
                        </p>
